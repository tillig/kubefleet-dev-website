---
title: Evicting Resources and Setting up Disruption Budgets
description: How to evict resources from a cluster and set up disruption budgets to protect against untimely evictions
weight: 15
---
