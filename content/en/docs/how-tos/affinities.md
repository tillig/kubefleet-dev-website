---
title: Using Affinity to Pick Clusters
description: How to use affinity settings in the `ClusterResourcePlacement` API to fine-tune Fleet scheduling decisions
weight: 4
---
...
adding/removing labels from a member cluster, see [Managing Member Clusters](clusters) How-To
Guide.
...
[How-To Guide: Using Property-Based Scheduling](property-based-scheduling).
